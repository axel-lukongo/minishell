...
void		add_to_list_front(int type, char *str, t_list **li,
				t_alloc **alloc);
...
t_tree		*create_exp_token_node(int type, char *str, t_tree **a,
				t_global *g);
...
void		double_dollar(char **result, t_global *g, t_vector2D *it,
				char *str);
void		dollar_question(char **result, t_global *g, t_vector2D *it,
				char *str);
//
// EXEC
...
t_token		**get_last_redir(t_tree *root, int type1, int type2,
				t_alloc **alloc);
